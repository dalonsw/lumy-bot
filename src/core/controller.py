...
from src.services.clima import Clima
dotenv.load_dotenv()
...
class Controlador:
    def __init__(self):
        ...
        self.servicos_registrados = {
            ...
            'musica_atual': self.spotify.musica_atual,
            ...
            'buscar_clima': self.buscar_clima,
        }
    ...
    def musica_atual(self):
        return self.spotify.musica_atual()
    ...
    def buscar_clima(self, localizacao: str) -> str:
        return self.clima.buscar_clima(localizacao)
